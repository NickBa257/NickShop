...
<body>
	...
	<div class="shirts">
		...
		<div class="row">
			...
			<div class="T">
				...
				<P>
					Nom:<%=p.getNom()%><br> <br> Prix:<%=p.getPrix()%>
					Fbu<br> <br> Quantite en Stock :<%=p.getQuantite()%><br>
					<br>
				</p>


				<form method="post">
					<button type="submit" formaction="Login.jsp">Commander</button>
				</form>
			</div>
	...
	<h2 align="center">Catégorie Pantalon</h2>
